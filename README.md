...
Папка `data/` нужна только для пересборки seed из исходных наборов данных. Сырые файлы JMDict, KANJIDIC2, KanjiVG и Tatoeba не коммитятся как обычные Git-файлы из-за размера; список ожидаемых файлов есть в `data/README.md`.
